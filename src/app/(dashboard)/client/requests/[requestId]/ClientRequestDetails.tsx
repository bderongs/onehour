...
import { updateClientRequest } from './actions';

interface ClientRequestDetailsProps {
  initialRequest: ClientRequest | null;
  initialSpark: Spark | null;
}
...
export default function ClientRequestDetails({ initialRequest, initialSpark }: ClientRequestDetailsProps) {
  const router = useRouter();
  const [request, setRequest] = useState<ClientRequest | null>(initialRequest);
  const [spark, setSpark] = useState<Spark | null>(initialSpark);
