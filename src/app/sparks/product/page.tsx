...
import { createClientRequest, getClientRequestsByClientId, type ClientRequest as ApiClientRequest } from '@/services/clientRequests';
...
// Use the API type instead of our local interface
type ClientRequest = ApiClientRequest;

export default function SparkProductPage() {
    const params = useParams<{ sparkUrl: string }>();
                    ...
                    getSparkByUrl(sparkUrl)
                        .then((spark: Spark | null) => {
                            ...
                            return getClientRequestsByClientId(user.id)
                                .then((requests: ApiClientRequest[]) => {
                        ...
                        {spark.faq && (
                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    {spark.faq.map((item: { question: string; answer: string }, index: number) => (
