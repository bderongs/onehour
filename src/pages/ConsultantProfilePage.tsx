            ...
            <div className="bg-amber-50 border-b border-amber-200">
                <div className="max-w-4xl mx-auto px-4 py-2 flex items-center justify-between">
                    <div className="flex items-center gap-2 text-amber-800">
                        ...
                        <p className="text-sm">Ceci est un profil exemple à des fins de démonstration. Les informations présentées ne sont pas réelles.</p>
                    </div>
                    <a href="/consultants" className="text-sm font-medium text-amber-800 hover:text-amber-900 flex items-center gap-1">
                        Créer mon profil
