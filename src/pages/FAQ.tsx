...
export function FAQ() {
    ...
    const faqs: FAQItem[] = [
        {
            question: "Qu'est-ce que OneHourConsulting ?",
            answer: "OneHourConsulting est un service de micro-consulting qui vous met en relation avec des experts qualifiés pour des sessions de conseil d'une heure. Notre plateforme permet de résoudre rapidement vos problématiques professionnelles avec l'aide d'experts triés sur le volet."
        },
        {
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600">
                        Tout ce que vous devez savoir sur OneHourConsulting
                    </p>
                </div>
                ...
                <div className="mt-12 text-center">
                    ...
                    <p className="mt-2">
                        <a
                            href="mailto:contact@onehour.consulting"
