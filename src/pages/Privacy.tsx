        ...
        <div className="bg-white min-h-screen py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="prose prose-lg text-gray-600">
                    <p>Chez OneHour, accessible depuis notre site web, l'une de nos principales priorités est la confidentialité de nos visiteurs. Ce document de Politique de Confidentialité contient les types d'informations qui sont collectées et enregistrées par OneHour et comment nous les utilisons.</p>
                    ...
                    <p>Comme tout autre site web, OneHour utilise des 'cookies'. Ces cookies sont utilisés pour stocker des informations, y compris les préférences des visiteurs, et les pages du site web que le visiteur a consultées ou visitées. Les informations sont utilisées pour optimiser l'expérience des utilisateurs en personnalisant le contenu de notre page web en fonction du type de navigateur des visiteurs et/ou d'autres informations.</p>
                    <h2>5. Politiques de Confidentialité des Tiers</h2>
                    <p>La Politique de Confidentialité de OneHour ne s'applique pas aux autres annonceurs ou sites web. Ainsi, nous vous conseillons de consulter les Politiques de Confidentialité respectives de ces serveurs publicitaires tiers pour des informations plus détaillées.</p>
                    ...
                    <p>Cette Politique de Confidentialité s'applique uniquement à nos activités en ligne et est valable pour les visiteurs de notre site web en ce qui concerne les informations qu'ils ont partagées et/ou collectées dans OneHour. Cette politique ne s'applique pas à toute information collectée hors ligne ou via des canaux autres que ce site web.</p>
